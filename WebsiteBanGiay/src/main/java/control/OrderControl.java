		...
		try {
			...
			String deliveryAddress = request.getParameter("deliveryAddress");
			 ...
			 HttpSession session = request.getSession();
				...
				email.setFrom("nguyenduytai59@gmail.com"); //email quan tri tai day [chu y dung email con hoat dong]
				email.setFromPassword("mkwpontuykkeijzk"); //mat khau email tren
